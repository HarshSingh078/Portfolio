            ...
            <div className="space-y-6 justify-center ">
              <div className="flex items-start space-x-4 ">
                ...
                <div>
                  ...
                  <a
                    href="mailto:harshsinghji0525@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors "
                  >
                    harshsinghji0525@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4 ">
            ...
            <form action="" className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="Harsh Singh..."
                />
              </div>
              <div>
